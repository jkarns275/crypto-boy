...
fun mitm(victimSocket: Socket, serverIp: InetAddress) {
    val messagesFromServer = ConcurrentLinkedQueue<ChatPacket>()
    thread { maliciousClient(serverIp, messagesFromServer) }
